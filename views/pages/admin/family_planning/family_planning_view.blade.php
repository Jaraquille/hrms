<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="bg-white rounded-lg p-10">
            <h1 class="uppercase font-bold mb-4">Family planning view</h1>
            <hr>
                  ...
                  <div class="p-4 steps" id="step1">
                      <div class="">
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-4">
                          <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                              <input type="text" readonly value="{{$plan->philhealth_id}}" name="philhealth_id" id="philhealth_id" autocomplete="philhealth_id" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
                          </div>
                          ...
                          <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                              <input type="text" readonly value="{{$plan->educational_attainment}}" name="educational_attainment" id="educational_attainment" autocomplete="educational_attainment" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                          <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                              <input type="text" readonly value="{{$plan->spouse_sname}}" name="spouse_sname" id="spouse_sname" autocomplete="spouse_sname" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
                          </div>
                          ...
                          <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                              <input type="text" readonly value="{{$plan->spouse_mname}}" name="spouse_mname" id="spouse_mname" autocomplete="spouse_mname" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
                          </div>
                          ...
                          <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                              <input type="text" readonly value="{{$plan->spouse_fname}}" name="spouse_fname" id="spouse_fname" autocomplete="spouse_fname" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                          <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                              <input type="number" readonly value="{{$plan->number_of_living_children}}" name="number_of_living_children" id="number_of_living_children" autocomplete="no_living_children" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
                          </div>
                          ...
                          <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                              {{-- <input type="text" readonly value="{{$plan->mname}}" name="mname" id="mname" autocomplete="mname" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"> --}}
                              <select name="plan_to_have_children" id="plan_to_have_children" disabled class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                          ...
                          <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                              <input type="number" readonly value="{{$plan->average_monthly_income}}" name="average_monthly_income" id="average_monthly_income" autocomplete="average_monthly_income" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-4">
                        <div class="sm:col-span-2">
                          ...
                          <div class="mt-1">
                            {{-- <input type="text" readonly value="{{$plan->mname}}" name="mname" id="mname" autocomplete="mname" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"> --}}
                            <select name="type_of_patient" id="type_of_patient" disabled class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        ...
                        <div class="sm:col-span-2">
                          ...
                          <div class="mt-1">
                            <input type="text" readonly value="{{$plan->reason}}" name="reason" id="reason" autocomplete="reason" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                          </div>
                        </div>
                       </div>
                       <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols">
                        <div class="sm:col-span">
                          ...
                          <div class="mt-1">
                            {{-- <input type="text" readonly value="{{$plan->mname}}" name="mname" id="mname" autocomplete="mname" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"> --}}
                            <select name="method" id="method" disabled class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                ...
                <div class="p-4 steps" id="step2">
                  ...
                  <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    <div class="sm:col-span-2">
                      ...
                      <div class="mt-1">
                        <select disabled name="step1_1" id="step1_1" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    ...
                    <div class="sm:col-span-2">
                      ...
                      <div class="mt-1">
                        {{-- <input type="text" readonly value="{{$plan->mname}}" name="mname" id="mname" autocomplete="mname" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"> --}}
                        <select disabled name="step1_2" id="step1_2" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    ...
                    <div class="sm:col-span-2">
                      ...
                      <div class="mt-1">
                        <select disabled name="step1_3" id="step1_3" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                  ...
                  <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                      <div class="sm:col-span-2">
                        ...
                        <div class="mt-1">
                          <select disabled name="step1_4" id="step1_4" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      ...
                      <div class="sm:col-span-2">
                        ...
                        <div class="mt-1">
                          {{-- <input type="text" readonly value="{{$plan->mname}}" name="mname" id="mname" autocomplete="mname" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"> --}}
                          <select disabled name="step1_5" id="step1_5" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      ...
                      <div class="sm:col-span-2">
                        ...
                        <div class="mt-1">
                          <select disabled name="step1_6" id="step1_6" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                      <div class="sm:col-span-2">
                        ...
                        <div class="mt-1">
                          <select disabled name="step1_7" id="step1_7" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      ...
                      <div class="sm:col-span-2">
                        ...
                        <div class="mt-1">
                          {{-- <input type="text" readonly value="{{$plan->mname}}" name="mname" id="mname" autocomplete="mname" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"> --}}
                          <select disabled name="step1_8" id="step1_8" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      ...
                      <div class="sm:col-span-2">
                        ...
                        <div class="mt-1">
                          <select disabled name="step1_9" id="step1_9" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                      <div class="sm:col-span-2">
                        ...
                        <div class="mt-1">
                          <select disabled name="step1_10" id="step1_10" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            <option {{$plan->step1_1 ? 'selected' : ''}} value="1">Yes</option>
                            <option {{!$plan->step1_1 ? 'selected' : ''}} value="0">No</option>
                          </select>
                        </div>
                      ...
                      <div class="sm:col-span-2">
                        ...
                        <div class="mt-1">
                          {{-- <input type="text" readonly value="{{$plan->mname}}" name="mname" id="mname" autocomplete="mname" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"> --}}
                          <select disabled name="step1_11" id="step1_11" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            <option {{$plan->step1_1 ? 'selected' : ''}} value="1">Yes</option>
                            <option {{!$plan->step1_1 ? 'selected' : ''}} value="0">No</option>
                          </select>
                        </div>
                      ...
                      <div class="sm:col-span-2">
                        ...
                        <div class="mt-1">
                          <select disabled name="step1_12" id="step1_12" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            <option {{$plan->step1_1 ? 'selected' : ''}} value="1">Yes</option>
                            <option {{!$plan->step1_1 ? 'selected' : ''}} value="0">No</option>
                          </select>
                        </div>
                ...
                <div class="p-4 steps" id="step3">
                  ...
                  <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    <div class="sm:col-span-1">
                      ...
                      <div class="mt-1">
                        <input type="text" readonly value="{{$plan->step2_g}}" name="step2_g" id="step2_g" autocomplete="step2_g" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      </div>
                    </div>
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <div class="mt-1">
                        <input type="text" readonly value="{{$plan->step2_p}}" name="step2_p" id="step2_p" autocomplete="step2_p" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      </div>
                    </div>
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <div class="mt-1">
                        <input type="text" readonly value="{{$plan->step2_full_term}}" name="step2_full_term" id="step2_full_term" autocomplete="step2_full_term" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      </div>
                    </div>
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <div class="mt-1">
                        <input type="text" readonly value="{{$plan->step2_premature}}" name="step2_premature" id="step2_premature" autocomplete="step2_premature" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      </div>
                    </div>
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <div class="mt-1">
                        <input type="text" readonly value="{{$plan->step2_abortion}}" name="step2_abortion" id="step2_abortion" autocomplete="step2_abortion" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      </div>
                    </div>
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <div class="mt-1">
                        <input type="text" readonly value="{{$plan->step2_living_children}}" name="step2_living_children" id="step2_living_children" autocomplete="step2_living_children" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    <div class="sm:col-span-2">
                      ...
                      <div class="mt-1">
                        <input type="date" readonly value="{{$plan->step2_last_delivery}}" name="step2_last_delivery" id="step2_last_delivery" autocomplete="step2_last_delivery" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      </div>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                      ...
                      <div class="mt-1">
                        <select disabled name="step2_type_last_delivery" id="step2_type_last_delivery" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    ...
                    <div class="sm:col-span-2">
                      ...
                      <div class="mt-1">
                        <input type="date" readonly value="{{$plan->step2_last_menstrual}}" name="step2_last_menstrual" id="step2_last_menstrual" autocomplete="step2_last_menstrual" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-4">
                    <div class="sm:col-span-2">
                      ...
                      <div class="mt-1">
                        <input type="date" readonly value="{{$plan->step2_previous_menstrual}}" name="step2_previous_menstrual" id="step2_previous_menstrual" autocomplete="step2_previous_menstrual" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      </div>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                      ...
                      <div class="mt-1">
                        <select disabled name="step2_menstrual_flow" id="step2_menstrual_flow" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                  ...
                  <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    <div class="sm:col-span-2">
                      ...
                      <div class="mt-1">
                        <select disabled name="step2_dysmenorrhea" id="step2_dysmenorrhea" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    ...
                    <div class="sm:col-span-2">
                      ...
                      <div class="mt-1">
                        {{-- <input type="text" readonly value="{{$plan->mname}}" name="mname" id="mname" autocomplete="mname" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"> --}}
                        <select disabled name="step2_hydatidiform_mole" id="step2_hydatidiform_mole" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    ...
                    <div class="sm:col-span-2">
                      ...
                      <div class="mt-1">
                        <select disabled name="step2_ectopic_pregnancy" id="step2_ectopic_pregnancy" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                ...
                <div class="p-4 steps" id="step4">
                  <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-4">
                    <div class="sm:col-span-1">
                      ...
                      <div class="mt-1">
                        <input type="text" readonly value="{{$plan->step3_weight}}" name="step3_weight" id="step3_weight" autocomplete="step3_weight" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      </div>
                    </div>
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <div class="mt-1">
                        <input type="text" readonly value="{{$plan->step3_height}}" name="step3_height" id="step3_height" autocomplete="step3_height" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      </div>
                    </div>
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <div class="mt-1">
                        <input type="text" readonly value="{{$plan->step3_blood_pressure}}" name="step3_blood_pressure" id="step3_blood_pressure" autocomplete="step3_blood_pressure" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      </div>
                    </div>
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <div class="mt-1">
                        <input type="text" readonly value="{{$plan->step3_pulse_rate}}" name="step3_pulse_rate" id="step3_pulse_rate" autocomplete="step3_pulse_rate" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    <div class="sm:col-span-2">
                      ...
                      <div class="mt-1">
                        <select disabled name="step3_skin" id="step3_skin" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    ...
                    <div class="sm:col-span-2">
                      ...
                      <div class="mt-1">
                        <select disabled name="step3_extormities" id="step3_extormities" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    ...
                    <div class="sm:col-span-2">
                      ...
                      <div class="mt-1">
                        <select disabled name="step3_conjunctiva" id="step3_conjunctiva" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                  ...
                  <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-4">
                    <div class="sm:col-span-1">
                      ...
                      <div class="mt-1">
                        <select disabled name="step3_pelvic" id="step3_pelvic" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                          <option {{$plan->step3_conjunctiva == 'normal' ? 'selected' : ""}} value="normal">normal</option>
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <div class="mt-1">
                        <select disabled name="step3_neck" id="step3_neck" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <div class="mt-1">
                        <select disabled name="step3_breast" id="step3_breast" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                          <option {{$plan->step3_neck == 'normal' ? 'selected' : '' }} value="normal">normal</option>
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <div class="mt-1">
                        <select disabled name="step3_abdomen" id="step3_abdomen" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                ...
                <div class="overflow-auto shadow ring-1 ring-black ring-opacity-5 md:rounded-lg mt-10">
                  ...
                  <div class="flex justify-between mt-4 pb-3">
                    <h1 class="m-2 font-bold">Assessments</h1>
                      ...
                      <a href="/assessmment-new/{{$plan->id}}" type="button" id="addassessment" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mr-2">
                        Add
                      </a>
                    @endif
                  </div>
                  <table class="min-w-full divide-y divide-gray-300">
                    <thead class="bg-gray-50">
                      <tr>
                        ...
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Medical Findings</th>
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Method Accepted</th>
