<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="bg-white rounded-lg p-10">
            <h1 class="uppercase font-bold mb-4">Family planning</h1>
            <hr>
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                      ...
                      @foreach ($patients as $patient)
                          <tr class="{{ $loop->iteration % 2 != 0 ? 'bg-white' : 'bg-gray-50' }}">
                              ...
                              <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                  <a href="family-planning-form/{{$patient->id}}" class="text-indigo-600 hover:text-indigo-900 uppercase">select</a>
                              </td>
                           </tr>
                      @endforeach
              ...
              {{-- display success --}}
                ...
                <div class="overflow-auto shadow ring-1 ring-black ring-opacity-5 md:rounded-lg mt-10">
                    <div class="p-2">
                        <h1 class="font-bold">Family Planning Records</h1>
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                      ...
                      <tbody class="bg-white">
                        ...
                        @foreach ($familyplannings as $familyplanning)
                            <tr class="{{ $loop->iteration % 2 != 0 ? 'bg-white' : 'bg-gray-50' }}">
                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">{{ $loop->iteration }}</td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ ucfirst($familyplanning->patient->name) }}</td>
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                    @foreach ($familyplanning->assessments as $assessment)
                                ...
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                  <a href="family-planning-view/{{$familyplanning->id}}" class="mr-2 text-indigo-600 hover:text-indigo-900">
                                    {{-- fontawesome view icon --}}
                                    <i class="fas fa-eye"></i>
                                  </a>
                                  <a href="family-planning-edit/{{$familyplanning->id}}" class="mr-2 text-blue-600 hover:text-blue-900">
                                    {{-- fontawesome edit icon --}}
                                    <i class="fas fa-edit"></i>
                                  </a>
                                  <a href="family-planning-delete/{{$familyplanning->id}}" class="text-red-600 hover:text-red-900">
                                    {{-- fontawesome edit icon --}}
